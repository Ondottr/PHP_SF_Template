...
var User = /** @class */ (function () {
    ...
    Object.defineProperty(User.prototype, "chatMessages", {
        get: function () {
    ...
    Object.defineProperty(User.prototype, "ep", {
        get: function () {
            return this._ep;
        },
        enumerable: false,
    ...
    Object.defineProperty(User.prototype, "userGroup", {
        get: function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, HttpProvider_1.default.get('/api/auth/me')];
                case 1:
                    response = _a.sent();
                    if (response && response.data)
                        return [2 /*return*/, (User.instance = new User(response.data))];
                    return [2 /*return*/];
            }
        });
    });
